...
namespace Config
{
	...
	namespace Aimbot {
    // ... other config ...
    inline float MaxFov = 300.0f;  // Only aim at targets within 120 pixels of crosshair
    inline float Smoothing = 4.0f; // Higher = slower, more legit
	}

	namespace Esp
	{
		inline bool enableEspBoxes = false;
		inline bool enableEspBoxesFilled = true;
		inline bool enableEspLines = false;
		inline bool enableEspHealthBar = true;
		inline bool enableEspArmorBar = false;
		...
		inline bool HeadFilled = true;
		inline bool ShowBoneJoints = true;
